...
export default class AddOrderRecord extends Component {
  constructor(props) {
    super(props);
  ...
  addOrderRecordSubmit = () => {
    this.props.navigation.navigate('OrderRecord');
  }


  cancelOrderRecordHandler = () => {
    this.props.navigation.navigate('OrderRecord');
  }
        ...
        <View style={[{ flex: 1, paddingHorizontal: 27, paddingVertical: 50 }, globalStyle.br24, globalStyle.purpleBg]}>
          ...
          <ScrollView style={{ height: "100%" }} keyboardShouldPersistTaps='handled'>
            <View style={{ height: "100%" }}>
              ...
              <RupiText text="ADD ORDER RECORD" style={globalStyle.formHeading}></RupiText>
              ...
              <View style={styles.buttonContainer}>
                <InvertButton onInvertItemPressed={this.cancelOrderRecordHandler} title="Cancel"></InvertButton>
                <NormalButton onItemPressed={this.addOrderRecordSubmit} title="Add Order Record"></NormalButton>
              </View>
